...
public:
    ...
    static void inDanhSachPhieu(vector<PhieuKhamBenh> ds) {
        ...
        int w3 = 12;  // MaChuNuoi
        int w4 = 10;  // MaThuoc
        int w5 = 15;  // SoLuongThuoc
        int w6 = 25;  // TrieuChung
        int w7 = 25;  // ChanDoan
    ...
    static void xuatBaoCaoKhamBenhRaFile(const vector<PhieuKhamBenh>& ds, string tenFile) {
        ...
        if (dsThang.empty()) {
            ...
            // Độ rộng cột
            const int w1 = 10;  // SoPhieu
            const int w2 = 15;  // NgayKham
            const int w3 = 12;  // MaChuNuoi
            const int w4 = 10;  // MaThuoc
            const int w5 = 15;  // SoLuongThuoc
            const int w6 = 30;  // TrieuChung
            const int w7 = 30;  // ChanDoan
