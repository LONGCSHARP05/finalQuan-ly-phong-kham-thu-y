...
public:
    ...
    static void inDanhSachChuNuoi(vector<DMChuNuoi>& danhSachChuNuoi) {
        int w1 = 10, w2 = 25, w3 = 30, w4 = 15, w5 = 75;
        ...
        for (size_t i = 0; i < danhSachChuNuoi.size(); i++) {
            if (!danhSachChuNuoi[i].f) {
                cout << "|" << left << setw(w1) << danhSachChuNuoi[i].maChuNuoi 
                     << "|" << setw(w2) << danhSachChuNuoi[i].tenChuNuoi 
                     << "|" << setw(w3) << danhSachChuNuoi[i].thongTinThuCung 
                     << "|" << setw(w4) << danhSachChuNuoi[i].soDienThoai 
                     << "|" << setw(w5) << danhSachChuNuoi[i].diaChi << "|" << endl;
